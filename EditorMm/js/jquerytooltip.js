...
config. BgColor			= 'CadetBlue'	// Background colour (HTML colour value, in quotes)
...
function tt_Browser()
{
	...
	if(tt_ie || n6 || tt_op || w3c)
	{
		if(tt_body && tt_db)
		{
			...
			tt_Err("jquerytooltip.js must be included INSIDE the body section,"
...
function tt_HideSrcTags()
{
	...
	if(!tt_HideSrcTagsRecurs(tt_body))
		tt_Err("There are HTML elements to be converted to tooltips.\nIf you"
				...
				+ " must edit jquerytooltip.js, and set TagsToTip in the global"
