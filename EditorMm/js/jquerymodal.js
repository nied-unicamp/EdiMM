var activeButtonElement;    
		...
		//attribute represents: 1: draw; 2: move; 3: delete; 4: move-path; 5: write
		...
		//layer = svg.getElementById('myLayer');
		movementLayer = document.getElementById('movement');

		svg.addEventListener('pointerdown', startPath, false);
		...
		function deleteFromSVGRect() { //alert("changed");
		removeEventListenerFromSVG(numberOfEventListener);
		...
		/**
		* function to start drawing the delete-Rectangle
		* mousedown
		*/
		...
		*/
		...
		/**
		* function to delete the elements within the deleteRectangle
		* mouse-up
		*/
		...
		/**
		* function to clear unused g-viewelements
		*/
		...
		/**
		* removes all Event-Listener on the svg-element
		*/
		...
		/**
		* deleting pathes from a drawn rectangle
		*/
